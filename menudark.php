...
<div class="menutop">
    ...
    <div><a href="menu.php" class="button">
...
<!--<a href="time.php" id="time">-->
<!--    Расписание-->
<!--</a>-->
<!--<a href="update.php" id="upd">-->
<!--    Что нового-->
<!--</a>-->
<form action="timedark.php" target="_blank">
    <button id="time">Расписание</button>
</form>
<form action="updatedark.php" target="_blank">
    <button id="upd">Что нового</button>
</form>


<div class="back">
    <div class="panel">
         <a href="index2.php" class="text">
            <img src="image/smallbluetext.png" width="50" height="50" alt="Кнопка">
        </a>
        <a href="joke.php" class="smile">
            <img src="image/smallbluesmile.png" width="50" height="50" alt="Кнопка">
        </a>
         <a href="cit.php" class="cit">
